 ...
 *
 * Usage:
 *   node foundry-svellheim-character-options/tools/build_svellheim_monsters_pack.js
...
const SOURCE_DIR = path.join(REPO_ROOT, 'foundry-svellheim-character-options', 'data', 'monsters');
